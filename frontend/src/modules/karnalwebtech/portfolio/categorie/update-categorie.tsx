...
export default function UpdatePostCategorie({ id }: UpdatePostCategorieProps) {
  ...
  useHandleNotifications({ error: error || updateError, isSuccess, successMessage: "Category updated successfully!", redirectPath: "/karnalwebtech/portfolio/categorie" })
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="dark-custom relative">
      {isLoading ? (
        ...
        <PostFromCard
          ...
          pageTitle="Categorie"
          discard_link="/karnalwebtech/portfolio/categorie"
