...
import {  useDeleteTagMutation, useGetAllTagQuery } from "../../../../state/karnal-web-tech/tagApi";
...
const TagList: React.FC<list_props> = () => {
  ...
  const [deleteTag, { error: deleteError, isLoading: deleteLoading, isSuccess }] = useDeleteTagMutation()
  useHandleNotifications({ error: error || deleteError, isSuccess, successMessage: "Tag deleted successfully!" })
          ...
          <TableCell>
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem className="cursor-pointer" onClick={() => router.push(`/karnalwebtech/post/tag/${post.tag_id}`)}>Edit Tag</DropdownMenuItem>
                <DropdownMenuItem className="cursor-pointer flex items-center" onClick={() => removeRow(post.tag_id)}><Trash2 color="red" /> Delete</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
