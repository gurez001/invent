...
export default function PostFromCard(
    {
        ...
        handleDrop,
        setValue,
        control, errors, watch, keywords, setKeywords, selectedCategories, setSelectedCategories
    }: PostFromCardProps) {
                    ...
                    <div className="block lg:flex gap-4">
                        ...
                        <div className="w-full lg:w-[70%]">
                            ...
                            >
                                ...
                                <TabsContent value="seo">
                                    <Seo_form control={control} errors={errors} watch={watch} setValue={setValue} setKeywords={setKeywords}
                                        keywords={keywords} />
                                </TabsContent>
                        ...
                        <div className="w-full lg:w-[30%]">
                            <ScrollArea className="h-[200px] w-full rounded-md border p-4">
                                <CategorySelector class_cat={"text-gray-200"} setSelectedCategories={setSelectedCategories} selectedCategories={selectedCategories} />
                            </ScrollArea>
                            {imageitemData ? (
    ...
    return (
        <div className="flex justify-between mt-6 pt-6 border-t border-zinc-800">
            ...
            <div className="space-x-2">
                ...
                <Button type="submit" className="bg-orange-600 hover:bg-orange-700">Post</Button>
            </div>
        </div>
    );
}
